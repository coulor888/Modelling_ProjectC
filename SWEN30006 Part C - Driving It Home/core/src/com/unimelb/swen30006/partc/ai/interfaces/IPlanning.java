...
public interface IPlanning {
	 ...
	 * and false if there is no route that gets the user within 50 units of the destination
	 ...
	 * @param visibility the visibility of current environment
	 ...
	 * given in seconds. If there is no destination, it returns -1.
	 * @return
	 */
	public float eta();
}
